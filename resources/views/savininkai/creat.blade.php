                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route("savininkai.save") }}">
                           ...
                           <div class="mb-3">
                               ...
                               <input class="form-control @error('vardas') is-invalid @enderror" name="vardas" type="text" value="{{ old('vardas') }}">
                               <div class="invalid-feedback">@error('vardas') {{ $message }} @enderror</div>
                           </div>
                           <div class="mb-3">
                               <label class="form-label">{{ __("messages.Pavardė") }}:</label>
                               <input class="form-control @error('pavarde') is-invalid @enderror" name="pavarde" type="text" value="{{ old('pavarde') }}">
